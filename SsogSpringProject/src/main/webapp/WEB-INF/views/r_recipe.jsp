      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="index.do">Home <i class="fa fa-chevron-right"></i></a></span> <span><a href="r_theme.do">테마추천 <i class="fa fa-chevron-right"></i></a></span> <span>레시피 <i class="fa fa-chevron-right"></i></span></p>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="<%--=conf.getImgUrl(fName) --%>" class="image-popup prod-img-bg"><img src="resources/img/1.jpg<%--=conf.getImgUrl(fName) --%>" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
          	...
          	<p><a href="cart.do" class="btn btn-primary py-3 px-5 mr-2">장바구니</a><a href="checkout.do" class="btn btn-primary py-3 px-5">결제하기</a></p>
    			</div>
    		</div>
