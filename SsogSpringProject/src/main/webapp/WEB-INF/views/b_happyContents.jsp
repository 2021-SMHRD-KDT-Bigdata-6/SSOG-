      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="index.do">Home <i class="fa fa-chevron-right"></i></a></span> <span class="mr-2"><a href="b_happyCook.do">커뮤니티 <i class="fa fa-chevron-right"></i></a></span> <span>해피COOK</span></p>
              ...
              <ul class="comment-list">
                <li class="comment">
                  ...
                  <div class="comment-body">
                    ...
                    <p> 와... 맛있어보여요... 고기 제가 구우면 맨날 숯덩이 되던데ㅠㅠ </p>
                    ...
                    <li class="comment">
                      ...
                      <ul class="children">
                        <li class="comment">
                          ...
                          <div class="comment-body">
                            <h3>고기식신이</h3>
                            <div class="meta">2021-11-20 9:20pm</div>
                            <p>고기는 2.5cm 정도 되는걸로 준비하시고, 굽기전에 소금 후추 밑간해두시구요~ 팬을 3분정도 강불에 예열하시고, 버터 넉넉히 둘러주신후에 처음엔 4분 뒤집어서 3분 구워주세용~ 그럼 저런 미디움이 나온답니다~~</p>
                            <p><a href="#" class="reply">Reply</a></p>
                          </div>
                            ...
                            <ul class="children">
                              <li class="comment">
                                ...
                                <div class="comment-body">
                                  <h3>멍멍아야옹해봐</h3>
                                  <div class="meta">2021-11-20 9:25pm</div>
                                  <p>꿀팁 감사합니당</p>
                                  <p><a href="#" class="reply">Reply</a></p>
                                </div>
                              </li>
                ...
                <li class="comment">
                  ...
                  <div class="comment-body">
                    <h3>노대동불주먹</h3>
                    <div class="meta">2021-11-21 12:04am</div>
                    <p>맛있겠다^^</p>
                    <p><a href="#" class="reply">Reply</a></p>
                  </div>
                </li>
