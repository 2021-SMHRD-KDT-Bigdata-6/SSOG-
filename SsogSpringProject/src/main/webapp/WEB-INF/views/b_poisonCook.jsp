      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="index.do">Home <i class="fa fa-chevron-right"></i></a></span> <span>커뮤니티 <i class="fa fa-chevron-right"></i></span><span>포이즌COOK</span></p>
            <h2 class="mb-0 bread">포이즌COOK</h2>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row d-flex">
          ...
          <% for(int i = 1; i < 7; i++){%><div class="col-lg-6 d-flex align-items-stretch ftco-animate" style="padding-left: 0px;">
          	<div class="blog-entry d-md-flex">
          		<a href="b_poisonContents.do" class="block-20 img" style="background-image: url('resources/images/image_<%=i %>_<%=i %>.jpg');">
              </a>
              <div class="text p-4 bg-light" id="pdbtWhy">
              	<div class="meta">
              		<p><span class="fa fa-calendar"></span> 2021-11-20 8:16pm </p>
              	</div>
                <h3 class="heading mb-3"><a href="#"> 스파게티 </a></h3>
          ...
          <!-- <div class="col-lg-6 d-flex align-items-stretch ftco-animate" style="padding-left: 0px;">
          	<div class="blog-entry d-md-flex">
          		<a href="PoisonCook2.jsp" class="block-20 img" style="background-image: url('resources/images/image_2_2.jpg');">
              </a>
               <div class="text p-4 bg-light" id="pdbtWhy">
              	<div class="meta">
              		<p><span class="fa fa-calendar"></span> 2021-11-20 8:16pm </p>
              	</div>
                <h3 class="heading mb-3"><a href="#"> ㅋㅋ외계 계란 후라이^^ </a></h3>
          ...
          <div class="col-lg-6 d-flex align-items-stretch ftco-animate" id="specialWhy">
          	<div class="blog-entry d-md-flex">
          		<a href="blog-single.html" class="block-20 img" style="background-image: url('images/image_3_3.jpg');">
              </a>
              <div class="text p-4 bg-light" id="pdbtWhy">
              	<div class="meta">
              		<p><span class="fa fa-calendar"></span> 2021-11-20 8:16pm </p>
              	</div>
                <h3 class="heading mb-3"><a href="#"> 딸기 탕후루 </a></h3>
          ...
          <div class="col-lg-6 d-flex align-items-stretch ftco-animate" id="specialWhy">
          	<div class="blog-entry d-md-flex">
          		<a href="blog-single.html" class="block-20 img" style="background-image: url('images/image_4_4.jpg');">
              </a>
              <div class="text p-4 bg-light" id="pdbtWhy">
              	<div class="meta">
              		<p><span class="fa fa-calendar"></span> 2021-11-20 8:16pm </p>
              	</div>
                <h3 class="heading mb-3"><a href="#"> 회가 왜 썩었냐 </a></h3>
